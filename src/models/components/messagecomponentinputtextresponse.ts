...
export function messageComponentInputTextResponseToJSON(
  messageComponentInputTextResponse: MessageComponentInputTextResponse,
): string {
  return JSON.stringify(
    MessageComponentInputTextResponse$outboundSchema.parse(
      messageComponentInputTextResponse,
    ),
  );
}

export function messageComponentInputTextResponseFromJSON(
  jsonString: string,
): SafeParseResult<MessageComponentInputTextResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => MessageComponentInputTextResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'MessageComponentInputTextResponse' from JSON`,
  );
}
