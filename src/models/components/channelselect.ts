...
/** @internal */
export const ChannelSelect$inboundSchema: z.ZodType<ChannelSelect, z.ZodTypeDef, unknown> = z
    .object({
        ...
        default_values: z.nullable(z.array(ChannelSelectDefaultValue$inboundSchema)).optional(),
...
> = z
    .object({
        ...
        disabled: z.nullable(z.boolean()).optional(),
        defaultValues: z.nullable(z.array(ChannelSelectDefaultValue$outboundSchema)).optional(),
