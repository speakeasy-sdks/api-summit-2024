...
/** @internal */
export const ErrorDetails$inboundSchema: z.ZodType<ErrorDetails, z.ZodTypeDef, unknown> = z.union([
    InnerErrors$inboundSchema,
    z.record(z.lazy(() => ErrorDetails$inboundSchema)),
]);

/** @internal */
export type ErrorDetails$Outbound = InnerErrors$Outbound | { [k: string]: ErrorDetails$Outbound };
...
export const ErrorDetails$outboundSchema: z.ZodType<
    ...
    z.ZodTypeDef,
    ErrorDetails
> = z.union([InnerErrors$outboundSchema, z.record(z.lazy(() => ErrorDetails$outboundSchema))]);
