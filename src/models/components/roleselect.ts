...
/** @internal */
export const RoleSelect$inboundSchema: z.ZodType<RoleSelect, z.ZodTypeDef, unknown> = z
    .object({
        ...
        default_values: z.nullable(z.array(RoleSelectDefaultValue$inboundSchema)).optional(),
    })
    .transform((v) => {
        return remap$(v, {
            custom_id: "customId",
...
/** @internal */
export const RoleSelect$outboundSchema: z.ZodType<RoleSelect$Outbound, z.ZodTypeDef, RoleSelect> = z
    .object({
        ...
        disabled: z.nullable(z.boolean()).optional(),
        defaultValues: z.nullable(z.array(RoleSelectDefaultValue$outboundSchema)).optional(),
    })
    .transform((v) => {
        return remap$(v, {
            customId: "custom_id",
