...
export function messageComponentButtonResponseToJSON(
  messageComponentButtonResponse: MessageComponentButtonResponse,
): string {
  return JSON.stringify(
    MessageComponentButtonResponse$outboundSchema.parse(
      messageComponentButtonResponse,
    ),
  );
}

export function messageComponentButtonResponseFromJSON(
  jsonString: string,
): SafeParseResult<MessageComponentButtonResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => MessageComponentButtonResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'MessageComponentButtonResponse' from JSON`,
  );
}
