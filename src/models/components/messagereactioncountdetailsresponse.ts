...
export namespace MessageReactionCountDetailsResponse$ {
    ...
    export const inboundSchema = MessageReactionCountDetailsResponse$inboundSchema;
    /** @deprecated use `MessageReactionCountDetailsResponse$outboundSchema` instead. */
    export const outboundSchema = MessageReactionCountDetailsResponse$outboundSchema;
