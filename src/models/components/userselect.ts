...
/** @internal */
export const UserSelect$inboundSchema: z.ZodType<UserSelect, z.ZodTypeDef, unknown> = z
    .object({
        ...
        default_values: z.nullable(z.array(UserSelectDefaultValue$inboundSchema)).optional(),
    })
    .transform((v) => {
        return remap$(v, {
            custom_id: "customId",
...
/** @internal */
export const UserSelect$outboundSchema: z.ZodType<UserSelect$Outbound, z.ZodTypeDef, UserSelect> = z
    .object({
        ...
        disabled: z.nullable(z.boolean()).optional(),
        defaultValues: z.nullable(z.array(UserSelectDefaultValue$outboundSchema)).optional(),
    })
    .transform((v) => {
        return remap$(v, {
            customId: "custom_id",
