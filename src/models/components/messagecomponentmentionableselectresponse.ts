...
/** @internal */
export const MessageComponentMentionableSelectResponse$outboundSchema: z.ZodType<
...
export namespace MessageComponentMentionableSelectResponse$ {
    ...
    export const inboundSchema = MessageComponentMentionableSelectResponse$inboundSchema;
    /** @deprecated use `MessageComponentMentionableSelectResponse$outboundSchema` instead. */
    export const outboundSchema = MessageComponentMentionableSelectResponse$outboundSchema;
