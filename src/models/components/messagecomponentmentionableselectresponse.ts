...
export function messageComponentMentionableSelectResponseToJSON(
  messageComponentMentionableSelectResponse:
    MessageComponentMentionableSelectResponse,
): string {
  return JSON.stringify(
    MessageComponentMentionableSelectResponse$outboundSchema.parse(
      messageComponentMentionableSelectResponse,
    ),
  );
}

export function messageComponentMentionableSelectResponseFromJSON(
  jsonString: string,
): SafeParseResult<
  MessageComponentMentionableSelectResponse,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      MessageComponentMentionableSelectResponse$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'MessageComponentMentionableSelectResponse' from JSON`,
  );
}
