...
export function messageComponentRoleSelectResponseToJSON(
  messageComponentRoleSelectResponse: MessageComponentRoleSelectResponse,
): string {
  return JSON.stringify(
    MessageComponentRoleSelectResponse$outboundSchema.parse(
      messageComponentRoleSelectResponse,
    ),
  );
}

export function messageComponentRoleSelectResponseFromJSON(
  jsonString: string,
): SafeParseResult<MessageComponentRoleSelectResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      MessageComponentRoleSelectResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'MessageComponentRoleSelectResponse' from JSON`,
  );
}
