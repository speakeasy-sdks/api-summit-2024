...
export function messageComponentStringSelectResponseToJSON(
  messageComponentStringSelectResponse: MessageComponentStringSelectResponse,
): string {
  return JSON.stringify(
    MessageComponentStringSelectResponse$outboundSchema.parse(
      messageComponentStringSelectResponse,
    ),
  );
}

export function messageComponentStringSelectResponseFromJSON(
  jsonString: string,
): SafeParseResult<MessageComponentStringSelectResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      MessageComponentStringSelectResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'MessageComponentStringSelectResponse' from JSON`,
  );
}
