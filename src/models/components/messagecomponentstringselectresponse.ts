...
export namespace MessageComponentStringSelectResponse$ {
    ...
    export const inboundSchema = MessageComponentStringSelectResponse$inboundSchema;
    /** @deprecated use `MessageComponentStringSelectResponse$outboundSchema` instead. */
    export const outboundSchema = MessageComponentStringSelectResponse$outboundSchema;
