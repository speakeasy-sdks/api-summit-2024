...
export function actionRowComponentsToJSON(
  actionRowComponents: ActionRowComponents,
): string {
  return JSON.stringify(
    ActionRowComponents$outboundSchema.parse(actionRowComponents),
  );
}

export function actionRowComponentsFromJSON(
  jsonString: string,
): SafeParseResult<ActionRowComponents, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ActionRowComponents$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ActionRowComponents' from JSON`,
  );
}
...
export function actionRowToJSON(actionRow: ActionRow): string {
  return JSON.stringify(ActionRow$outboundSchema.parse(actionRow));
}

export function actionRowFromJSON(
  jsonString: string,
): SafeParseResult<ActionRow, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ActionRow$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ActionRow' from JSON`,
  );
}
