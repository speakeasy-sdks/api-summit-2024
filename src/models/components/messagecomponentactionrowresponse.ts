...
export function messageComponentActionRowResponseToJSON(
  messageComponentActionRowResponse: MessageComponentActionRowResponse,
): string {
  return JSON.stringify(
    MessageComponentActionRowResponse$outboundSchema.parse(
      messageComponentActionRowResponse,
    ),
  );
}

export function messageComponentActionRowResponseFromJSON(
  jsonString: string,
): SafeParseResult<MessageComponentActionRowResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => MessageComponentActionRowResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'MessageComponentActionRowResponse' from JSON`,
  );
}
