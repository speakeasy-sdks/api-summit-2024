...
> = z.object({
    ...
    recipients: z.nullable(z.array(InviteChannelRecipientResponse$inboundSchema)).optional(),
});
...
export type InviteChannelResponse$Outbound = {
    ...
    name?: string | null | undefined;
    icon?: string | null | undefined;
    recipients?: Array<InviteChannelRecipientResponse$Outbound> | null | undefined;
};
...
> = z.object({
    ...
    name: z.nullable(z.string()).optional(),
    icon: z.nullable(z.string()).optional(),
    recipients: z.nullable(z.array(InviteChannelRecipientResponse$outboundSchema)).optional(),
});
