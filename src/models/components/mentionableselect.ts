...
export type MentionableSelect = {
    ...
    defaultValues?: Array<RoleSelectDefaultValue | UserSelectDefaultValue> | null | undefined;
};

/** @internal */
export const DefaultValues$inboundSchema: z.ZodType<DefaultValues, z.ZodTypeDef, unknown> = z.union(
    [RoleSelectDefaultValue$inboundSchema, UserSelectDefaultValue$inboundSchema]
);
...
export const DefaultValues$outboundSchema: z.ZodType<
    ...
    z.ZodTypeDef,
    DefaultValues
> = z.union([RoleSelectDefaultValue$outboundSchema, UserSelectDefaultValue$outboundSchema]);
...
/** @internal */
export const MentionableSelect$inboundSchema: z.ZodType<MentionableSelect, z.ZodTypeDef, unknown> =
    z
        .object({
