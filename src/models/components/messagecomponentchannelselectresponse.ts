...
export function messageComponentChannelSelectResponseToJSON(
  messageComponentChannelSelectResponse: MessageComponentChannelSelectResponse,
): string {
  return JSON.stringify(
    MessageComponentChannelSelectResponse$outboundSchema.parse(
      messageComponentChannelSelectResponse,
    ),
  );
}

export function messageComponentChannelSelectResponseFromJSON(
  jsonString: string,
): SafeParseResult<MessageComponentChannelSelectResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      MessageComponentChannelSelectResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'MessageComponentChannelSelectResponse' from JSON`,
  );
}
