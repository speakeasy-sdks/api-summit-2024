...
export async function messagesUpdate(
    client$: DiscordCore,
...
> {
    ...
    const body$ = encodeJSON$("body", payload$.MessageEditRequestPartial, { explode: true });
    ...
    const path$ = pathToFunc("/channels/{channel_id}/messages/{message_id}")(pathParams$);
